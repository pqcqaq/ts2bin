...
| Phase 3 entry | in progress / ready for Linux continuation | `OBJ-000a`、`OBJ-000b/BE-004b`、`GC-001a/BE-003b`、`RT-006a`、`VERT-010..013b` 与 `OBJ-004` 已完成本地 `SelfAudited`/实现门禁；OBJ-003b/005/006 已完成实现与 tagged evidence 接线，迁移后按 [Linux 交接文档](plans/phase3-linux-handoff-2026-08-12.md) 先做 authoritative runtime rebuild，再关闭 O0/O2、ELF、native/Node 和 interop positive binding；随后进入 RT-003a 与 MOD/EH 主线。CI 继续 owner-deferred。 |
